  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 flex items-center justify-center py-12 px-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 w-full max-w-md">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900">Become a Technician</h1>
                <p className="text-gray-600 mt-2">Register your skills and start earning</p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 space-y-4">
                <p className="text-gray-600 text-sm">
                    Just a customer? <Link to="/register" className="font-semibold text-blue-600 hover:text-blue-700">Register here</Link>
                </p>
                <p className="text-gray-600 text-sm">
